...
export interface LicenseIdentification {
  ...
  purchaseId?: Uint8Array | undefined;
  type?: LicenseType | undefined;
  version?: number | undefined;
  providerSessionToken?: Uint8Array | undefined;
}
...
export interface License_KeyContainer_KeyControl {
   ...
   */
  keyControlBlock?: Uint8Array | undefined;
  iv?: Uint8Array | undefined;
}
...
export interface License_KeyContainer_OutputProtection {
  ...
  hdcpSrmRule?:
    | License_KeyContainer_OutputProtection_HdcpSrmRule
    | undefined;
...
export function license_KeyContainer_OutputProtection_HDCPFromJSON(
  object: any,
...
export function license_KeyContainer_OutputProtection_HDCPToJSON(
  object: License_KeyContainer_OutputProtection_HDCP,
): string {
  switch (object) {
...
export function license_KeyContainer_OutputProtection_CGMSFromJSON(
  object: any,
...
export function license_KeyContainer_OutputProtection_CGMSToJSON(
  object: License_KeyContainer_OutputProtection_CGMS,
): string {
  switch (object) {
...
export function license_KeyContainer_OutputProtection_HdcpSrmRuleFromJSON(
  object: any,
): License_KeyContainer_OutputProtection_HdcpSrmRule {
  switch (object) {
    case 0:
...
export function license_KeyContainer_OutputProtection_HdcpSrmRuleToJSON(
...
export interface LicenseRequest {
  ...
  keyControlNonceDeprecated?: Uint8Array | undefined;
  protocolVersion?:
    | ProtocolVersion
    | undefined;
  /**
...
export interface LicenseRequest_ContentIdentification_ExistingLicense {
  ...
  sessionUsageTableEntry?: Uint8Array | undefined;
}
...
export interface SignedMessage {
   ...
   */
  remoteAttestation?: Uint8Array | undefined;
   ...
   */
  oemcryptoCoreMessage?: Uint8Array | undefined;
}
...
export function clientIdentification_ClientCapabilities_HdcpVersionFromJSON(
  object: any,
...
export function clientIdentification_ClientCapabilities_HdcpVersionToJSON(
  object: ClientIdentification_ClientCapabilities_HdcpVersion,
): string {
  switch (object) {
...
export interface EncryptedClientIdentification {
  ...
  encryptedPrivacyKey?: Uint8Array | undefined;
}
...
export interface WidevinePsshData {
   ...
   * @deprecated
   */
  groupedLicense?: Uint8Array | undefined;
}
...
function createBaseLicenseIdentification(): LicenseIdentification {
  return {
    ...
    purchaseId: new Uint8Array(0),
    type: 1,
    version: 0,
    providerSessionToken: new Uint8Array(0),
  };
}
...
export const LicenseIdentification = {
  ...
  fromJSON(object: any): LicenseIdentification {
    return {
      ...
      purchaseId: isSet(object.purchaseId) ? bytesFromBase64(object.purchaseId) : new Uint8Array(0),
      type: isSet(object.type) ? licenseTypeFromJSON(object.type) : 1,
      version: isSet(object.version) ? globalThis.Number(object.version) : 0,
      providerSessionToken: isSet(object.providerSessionToken)
        ? bytesFromBase64(object.providerSessionToken)
        : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LicenseIdentification>, I>>(object: I): LicenseIdentification {
    ...
    message.purchaseId = object.purchaseId ?? new Uint8Array(0);
    message.type = object.type ?? 1;
    message.version = object.version ?? 0;
    message.providerSessionToken = object.providerSessionToken ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseLicense(): License {
  return {
    ...
    providerClientToken: new Uint8Array(0),
    protectionScheme: 0,
    srmRequirement: new Uint8Array(0),
    srmUpdate: new Uint8Array(0),
...
export const License = {
  ...
  fromJSON(object: any): License {
    return {
      ...
      remoteAttestationVerified: isSet(object.remoteAttestationVerified)
        ? globalThis.Boolean(object.remoteAttestationVerified)
        : false,
      providerClientToken: isSet(object.providerClientToken)
        ? bytesFromBase64(object.providerClientToken)
        : new Uint8Array(0),
      protectionScheme: isSet(object.protectionScheme) ? globalThis.Number(object.protectionScheme) : 0,
      srmRequirement: isSet(object.srmRequirement) ? bytesFromBase64(object.srmRequirement) : new Uint8Array(0),
      srmUpdate: isSet(object.srmUpdate) ? bytesFromBase64(object.srmUpdate) : new Uint8Array(0),
      platformVerificationStatus: isSet(object.platformVerificationStatus)
        ...
        : 4,
      groupIds: globalThis.Array.isArray(object?.groupIds) ? object.groupIds.map((e: any) => bytesFromBase64(e)) : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<License>, I>>(object: I): License {
    ...
    message.id = (object.id !== undefined && object.id !== null)
      ? LicenseIdentification.fromPartial(object.id)
      : undefined;
    message.policy = (object.policy !== undefined && object.policy !== null)
      ? License_Policy.fromPartial(object.policy)
      : undefined;
    message.key = object.key?.map((e) => License_KeyContainer.fromPartial(e)) || [];
    message.licenseStartTime = (object.licenseStartTime !== undefined && object.licenseStartTime !== null)
      ? Long.fromValue(object.licenseStartTime)
      : Long.ZERO;
    message.remoteAttestationVerified = object.remoteAttestationVerified ?? false;
    message.providerClientToken = object.providerClientToken ?? new Uint8Array(0);
    message.protectionScheme = object.protectionScheme ?? 0;
    message.srmRequirement = object.srmRequirement ?? new Uint8Array(0);
    message.srmUpdate = object.srmUpdate ?? new Uint8Array(0);
...
export const License_Policy = {
  encode(message: License_Policy, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (
      ...
      !message.renewalRecoveryDurationSeconds.equals(Long.fromNumber(0))
    ) {
    ...
    if (
      ...
      !message.renewalRetryIntervalSeconds.equals(Long.fromNumber(0))
    ) {
    ...
    if (
      ...
      !message.playStartGracePeriodSeconds.equals(Long.fromNumber(0))
    ) {
  ...
  fromJSON(object: any): License_Policy {
    return {
      ...
      rentalDurationSeconds: isSet(object.rentalDurationSeconds)
        ? Long.fromValue(object.rentalDurationSeconds)
        : Long.fromNumber(0),
      playbackDurationSeconds: isSet(object.playbackDurationSeconds)
        ? Long.fromValue(object.playbackDurationSeconds)
        : Long.fromNumber(0),
      licenseDurationSeconds: isSet(object.licenseDurationSeconds)
      ...
      renewalDelaySeconds: isSet(object.renewalDelaySeconds)
      ...
      alwaysIncludeClientId: isSet(object.alwaysIncludeClientId)
        ? globalThis.Boolean(object.alwaysIncludeClientId)
        : false,
      playStartGracePeriodSeconds: isSet(object.playStartGracePeriodSeconds)
        ? Long.fromValue(object.playStartGracePeriodSeconds)
        : Long.fromNumber(0),
      softEnforcePlaybackDuration: isSet(object.softEnforcePlaybackDuration)
        ? globalThis.Boolean(object.softEnforcePlaybackDuration)
        : false,
      softEnforceRentalDuration: isSet(object.softEnforceRentalDuration)
        ? globalThis.Boolean(object.softEnforceRentalDuration)
        : true,
    };
  },
...
export const License_KeyContainer = {
  encode(message: License_KeyContainer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.operatorSessionKeyPermissions !== undefined) {
      License_KeyContainer_OperatorSessionKeyPermissions.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.operatorSessionKeyPermissions = License_KeyContainer_OperatorSessionKeyPermissions.decode(
            reader,
            reader.uint32(),
          );
          continue;
        case 10:
          ...
          message.videoResolutionConstraints.push(
            License_KeyContainer_VideoResolutionConstraint.decode(reader, reader.uint32()),
          );
          continue;
        case 11:
          if (tag !== 88) {
  ...
  fromJSON(object: any): License_KeyContainer {
    return {
      ...
      requiredProtection: isSet(object.requiredProtection)
        ? License_KeyContainer_OutputProtection.fromJSON(object.requiredProtection)
        : undefined,
      requestedProtection: isSet(object.requestedProtection)
        ? License_KeyContainer_OutputProtection.fromJSON(object.requestedProtection)
        : undefined,
      ...
      videoResolutionConstraints: globalThis.Array.isArray(object?.videoResolutionConstraints)
        ...
        : [],
      antiRollbackUsageTable: isSet(object.antiRollbackUsageTable)
        ? globalThis.Boolean(object.antiRollbackUsageTable)
        : false,
  ...
  toJSON(message: License_KeyContainer): unknown {
    ...
    if (message.operatorSessionKeyPermissions !== undefined) {
      obj.operatorSessionKeyPermissions = License_KeyContainer_OperatorSessionKeyPermissions.toJSON(
        message.operatorSessionKeyPermissions,
      );
    }
    if (message.videoResolutionConstraints?.length) {
      obj.videoResolutionConstraints = message.videoResolutionConstraints.map((e) =>
        License_KeyContainer_VideoResolutionConstraint.toJSON(e)
      );
    }
    if (message.antiRollbackUsageTable !== undefined && message.antiRollbackUsageTable !== false) {
  ...
  fromPartial<I extends Exact<DeepPartial<License_KeyContainer>, I>>(object: I): License_KeyContainer {
    ...
    message.requiredProtection = (object.requiredProtection !== undefined && object.requiredProtection !== null)
      ? License_KeyContainer_OutputProtection.fromPartial(object.requiredProtection)
      : undefined;
    message.requestedProtection = (object.requestedProtection !== undefined && object.requestedProtection !== null)
      ? License_KeyContainer_OutputProtection.fromPartial(object.requestedProtection)
      : undefined;
    message.keyControl = (object.keyControl !== undefined && object.keyControl !== null)
      ? License_KeyContainer_KeyControl.fromPartial(object.keyControl)
      : undefined;
    message.operatorSessionKeyPermissions =
...
function createBaseLicense_KeyContainer_KeyControl(): License_KeyContainer_KeyControl {
  return { keyControlBlock: new Uint8Array(0), iv: new Uint8Array(0) };
}
...
export const License_KeyContainer_KeyControl = {
  ...
  fromJSON(object: any): License_KeyContainer_KeyControl {
    return {
      keyControlBlock: isSet(object.keyControlBlock) ? bytesFromBase64(object.keyControlBlock) : new Uint8Array(0),
      iv: isSet(object.iv) ? bytesFromBase64(object.iv) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<License_KeyContainer_KeyControl>, I>>(
    object: I,
  ): License_KeyContainer_KeyControl {
    const message = createBaseLicense_KeyContainer_KeyControl();
    message.keyControlBlock = object.keyControlBlock ?? new Uint8Array(0);
    message.iv = object.iv ?? new Uint8Array(0);
    return message;
  },
};
...
export const License_KeyContainer_OutputProtection = {
  ...
  fromJSON(object: any): License_KeyContainer_OutputProtection {
    return {
      ...
      hdcpSrmRule: isSet(object.hdcpSrmRule)
        ? license_KeyContainer_OutputProtection_HdcpSrmRuleFromJSON(object.hdcpSrmRule)
        : 0,
      disableAnalogOutput: isSet(object.disableAnalogOutput) ? globalThis.Boolean(object.disableAnalogOutput) : false,
      disableDigitalOutput: isSet(object.disableDigitalOutput)
        ? globalThis.Boolean(object.disableDigitalOutput)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<License_KeyContainer_OutputProtection>, I>>(
    base?: I,
  ): License_KeyContainer_OutputProtection {
    return License_KeyContainer_OutputProtection.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<License_KeyContainer_OutputProtection>, I>>(
    object: I,
  ): License_KeyContainer_OutputProtection {
    const message = createBaseLicense_KeyContainer_OutputProtection();
...
export const License_KeyContainer_VideoResolutionConstraint = {
  encode(
    message: License_KeyContainer_VideoResolutionConstraint,
  ...
  create<I extends Exact<DeepPartial<License_KeyContainer_VideoResolutionConstraint>, I>>(
    base?: I,
...
export const License_KeyContainer_OperatorSessionKeyPermissions = {
  encode(
    message: License_KeyContainer_OperatorSessionKeyPermissions,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromJSON(object: any): License_KeyContainer_OperatorSessionKeyPermissions {
    return {
      ...
      allowSignatureVerify: isSet(object.allowSignatureVerify)
        ? globalThis.Boolean(object.allowSignatureVerify)
        : false,
    };
  },
...
function createBaseLicenseRequest(): LicenseRequest {
  return {
    ...
    keyControlNonceDeprecated: new Uint8Array(0),
    protocolVersion: 20,
    keyControlNonce: 0,
...
export const LicenseRequest = {
  ...
  fromJSON(object: any): LicenseRequest {
    return {
      ...
      keyControlNonceDeprecated: isSet(object.keyControlNonceDeprecated)
        ? bytesFromBase64(object.keyControlNonceDeprecated)
        : new Uint8Array(0),
      ...
      encryptedClientId: isSet(object.encryptedClientId)
        ? EncryptedClientIdentification.fromJSON(object.encryptedClientId)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LicenseRequest>, I>>(object: I): LicenseRequest {
    ...
    message.clientId = (object.clientId !== undefined && object.clientId !== null)
      ? ClientIdentification.fromPartial(object.clientId)
      : undefined;
    message.contentId = (object.contentId !== undefined && object.contentId !== null)
      ? LicenseRequest_ContentIdentification.fromPartial(object.contentId)
      : undefined;
    message.type = object.type ?? 1;
    message.requestTime = (object.requestTime !== undefined && object.requestTime !== null)
      ? Long.fromValue(object.requestTime)
      : Long.ZERO;
    message.keyControlNonceDeprecated = object.keyControlNonceDeprecated ?? new Uint8Array(0);
    message.protocolVersion = object.protocolVersion ?? 20;
    message.keyControlNonce = object.keyControlNonce ?? 0;
    message.encryptedClientId = (object.encryptedClientId !== undefined && object.encryptedClientId !== null)
...
export const LicenseRequest_ContentIdentification = {
  encode(message: LicenseRequest_ContentIdentification, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.widevinePsshData !== undefined) {
      LicenseRequest_ContentIdentification_WidevinePsshData.encode(message.widevinePsshData, writer.uint32(10).fork())
        .ldelim();
    }
    ...
    if (message.existingLicense !== undefined) {
      LicenseRequest_ContentIdentification_ExistingLicense.encode(message.existingLicense, writer.uint32(26).fork())
        .ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.widevinePsshData = LicenseRequest_ContentIdentification_WidevinePsshData.decode(
            reader,
            reader.uint32(),
          );
          continue;
        ...
        case 3:
          ...
          message.existingLicense = LicenseRequest_ContentIdentification_ExistingLicense.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): LicenseRequest_ContentIdentification {
    return {
      widevinePsshData: isSet(object.widevinePsshData)
        ...
        : undefined,
      webmKeyId: isSet(object.webmKeyId)
        ? LicenseRequest_ContentIdentification_WebmKeyId.fromJSON(object.webmKeyId)
        : undefined,
      ...
      initData: isSet(object.initData)
        ? LicenseRequest_ContentIdentification_InitData.fromJSON(object.initData)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification>, I>>(
    base?: I,
  ): LicenseRequest_ContentIdentification {
    return LicenseRequest_ContentIdentification.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification>, I>>(
    object: I,
  ): LicenseRequest_ContentIdentification {
    const message = createBaseLicenseRequest_ContentIdentification();
    message.widevinePsshData = (object.widevinePsshData !== undefined && object.widevinePsshData !== null)
      ? LicenseRequest_ContentIdentification_WidevinePsshData.fromPartial(object.widevinePsshData)
      : undefined;
    message.webmKeyId = (object.webmKeyId !== undefined && object.webmKeyId !== null)
      ? LicenseRequest_ContentIdentification_WebmKeyId.fromPartial(object.webmKeyId)
      : undefined;
    message.existingLicense = (object.existingLicense !== undefined && object.existingLicense !== null)
      ? LicenseRequest_ContentIdentification_ExistingLicense.fromPartial(object.existingLicense)
      : undefined;
    message.initData = (object.initData !== undefined && object.initData !== null)
...
function createBaseLicenseRequest_ContentIdentification_WidevinePsshData(): LicenseRequest_ContentIdentification_WidevinePsshData {
  return { psshData: [], licenseType: 1, requestId: new Uint8Array(0) };
}

export const LicenseRequest_ContentIdentification_WidevinePsshData = {
  encode(
    message: LicenseRequest_ContentIdentification_WidevinePsshData,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromJSON(object: any): LicenseRequest_ContentIdentification_WidevinePsshData {
    return {
      psshData: globalThis.Array.isArray(object?.psshData) ? object.psshData.map((e: any) => bytesFromBase64(e)) : [],
...
function createBaseLicenseRequest_ContentIdentification_WebmKeyId(): LicenseRequest_ContentIdentification_WebmKeyId {
  return { header: new Uint8Array(0), licenseType: 1, requestId: new Uint8Array(0) };
}

export const LicenseRequest_ContentIdentification_WebmKeyId = {
  encode(
    message: LicenseRequest_ContentIdentification_WebmKeyId,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  create<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification_WebmKeyId>, I>>(
    base?: I,
...
function createBaseLicenseRequest_ContentIdentification_ExistingLicense(): LicenseRequest_ContentIdentification_ExistingLicense {
  return {
    ...
    sessionUsageTableEntry: new Uint8Array(0),
  };
}

export const LicenseRequest_ContentIdentification_ExistingLicense = {
  encode(
    message: LicenseRequest_ContentIdentification_ExistingLicense,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
  ...
  fromJSON(object: any): LicenseRequest_ContentIdentification_ExistingLicense {
    return {
      ...
      secondsSinceLastPlayed: isSet(object.secondsSinceLastPlayed)
        ? Long.fromValue(object.secondsSinceLastPlayed)
        : Long.ZERO,
      sessionUsageTableEntry: isSet(object.sessionUsageTableEntry)
        ? bytesFromBase64(object.sessionUsageTableEntry)
        : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification_ExistingLicense>, I>>(
    ...
    const message = createBaseLicenseRequest_ContentIdentification_ExistingLicense();
    message.licenseId = (object.licenseId !== undefined && object.licenseId !== null)
      ? LicenseIdentification.fromPartial(object.licenseId)
      : undefined;
    message.secondsSinceStarted = (object.secondsSinceStarted !== undefined && object.secondsSinceStarted !== null)
    ...
    message.secondsSinceLastPlayed =
      (object.secondsSinceLastPlayed !== undefined && object.secondsSinceLastPlayed !== null)
        ? Long.fromValue(object.secondsSinceLastPlayed)
        : Long.ZERO;
    message.sessionUsageTableEntry = object.sessionUsageTableEntry ?? new Uint8Array(0);
    return message;
  },
};

function createBaseLicenseRequest_ContentIdentification_InitData(): LicenseRequest_ContentIdentification_InitData {
  return { initDataType: 1, initData: new Uint8Array(0), licenseType: 1, requestId: new Uint8Array(0) };
}
...
export const LicenseRequest_ContentIdentification_InitData = {
  ...
  fromJSON(object: any): LicenseRequest_ContentIdentification_InitData {
    return {
      initDataType: isSet(object.initDataType)
        ? licenseRequest_ContentIdentification_InitData_InitDataTypeFromJSON(object.initDataType)
        : 1,
  ...
  create<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification_InitData>, I>>(
    base?: I,
...
export const MetricData = {
  ...
  fromJSON(object: any): MetricData {
    return {
      ...
      metricData: globalThis.Array.isArray(object?.metricData)
        ? object.metricData.map((e: any) => MetricData_TypeValue.fromJSON(e))
        : [],
    };
  },
...
function createBaseSignedMessage(): SignedMessage {
  return {
    ...
    remoteAttestation: new Uint8Array(0),
    metricData: [],
    serviceVersionInfo: undefined,
    sessionKeyType: 1,
    oemcryptoCoreMessage: new Uint8Array(0),
  };
}
...
export const SignedMessage = {
  ...
  fromJSON(object: any): SignedMessage {
    return {
      ...
      sessionKey: isSet(object.sessionKey) ? bytesFromBase64(object.sessionKey) : new Uint8Array(0),
      remoteAttestation: isSet(object.remoteAttestation)
        ? bytesFromBase64(object.remoteAttestation)
        : new Uint8Array(0),
      metricData: globalThis.Array.isArray(object?.metricData)
        ? object.metricData.map((e: any) => MetricData.fromJSON(e))
        : [],
      serviceVersionInfo: isSet(object.serviceVersionInfo)
        ? VersionInfo.fromJSON(object.serviceVersionInfo)
        : undefined,
      sessionKeyType: isSet(object.sessionKeyType) ? signedMessage_SessionKeyTypeFromJSON(object.sessionKeyType) : 1,
      oemcryptoCoreMessage: isSet(object.oemcryptoCoreMessage)
        ? bytesFromBase64(object.oemcryptoCoreMessage)
        : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SignedMessage>, I>>(object: I): SignedMessage {
    ...
    message.remoteAttestation = object.remoteAttestation ?? new Uint8Array(0);
    message.metricData = object.metricData?.map((e) => MetricData.fromPartial(e)) || [];
    message.serviceVersionInfo = (object.serviceVersionInfo !== undefined && object.serviceVersionInfo !== null)
      ? VersionInfo.fromPartial(object.serviceVersionInfo)
      : undefined;
    message.sessionKeyType = object.sessionKeyType ?? 1;
    message.oemcryptoCoreMessage = object.oemcryptoCoreMessage ?? new Uint8Array(0);
    return message;
  },
};
...
export const ClientIdentification = {
  ...
  fromJSON(object: any): ClientIdentification {
    return {
      ...
      clientInfo: globalThis.Array.isArray(object?.clientInfo)
        ? object.clientInfo.map((e: any) => ClientIdentification_NameValue.fromJSON(e))
        : [],
      providerClientToken: isSet(object.providerClientToken)
        ? bytesFromBase64(object.providerClientToken)
        : new Uint8Array(0),
      ...
      clientCapabilities: isSet(object.clientCapabilities)
        ? ClientIdentification_ClientCapabilities.fromJSON(object.clientCapabilities)
        : undefined,
      vmpData: isSet(object.vmpData) ? bytesFromBase64(object.vmpData) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<ClientIdentification>, I>>(object: I): ClientIdentification {
    ...
    message.clientCapabilities = (object.clientCapabilities !== undefined && object.clientCapabilities !== null)
      ...
      : undefined;
    message.vmpData = object.vmpData ?? new Uint8Array(0);
    message.deviceCredentials =
      object.deviceCredentials?.map((e) => ClientIdentification_ClientCredentials.fromPartial(e)) || [];
    return message;
  },
};
...
export const ClientIdentification_NameValue = {
  ...
  fromPartial<I extends Exact<DeepPartial<ClientIdentification_NameValue>, I>>(
    object: I,
...
export const ClientIdentification_ClientCapabilities = {
  ...
  fromJSON(object: any): ClientIdentification_ClientCapabilities {
    return {
      ...
      videoResolutionConstraints: isSet(object.videoResolutionConstraints)
        ? globalThis.Boolean(object.videoResolutionConstraints)
        : false,
      maxHdcpVersion: isSet(object.maxHdcpVersion)
        ? clientIdentification_ClientCapabilities_HdcpVersionFromJSON(object.maxHdcpVersion)
        : 0,
      ...
      supportedCertificateKeyType: globalThis.Array.isArray(object?.supportedCertificateKeyType)
        ? object.supportedCertificateKeyType.map((e: any) =>
          clientIdentification_ClientCapabilities_CertificateKeyTypeFromJSON(e)
        )
        : [],
      analogOutputCapabilities: isSet(object.analogOutputCapabilities)
        ...
        : 0,
      canDisableAnalogOutput: isSet(object.canDisableAnalogOutput)
        ? globalThis.Boolean(object.canDisableAnalogOutput)
        : false,
  ...
  toJSON(message: ClientIdentification_ClientCapabilities): unknown {
    ...
    if (message.analogOutputCapabilities !== undefined && message.analogOutputCapabilities !== 0) {
      obj.analogOutputCapabilities = clientIdentification_ClientCapabilities_AnalogOutputCapabilitiesToJSON(
  ...
  create<I extends Exact<DeepPartial<ClientIdentification_ClientCapabilities>, I>>(
    base?: I,
  ): ClientIdentification_ClientCapabilities {
    return ClientIdentification_ClientCapabilities.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ClientIdentification_ClientCapabilities>, I>>(
    object: I,
  ): ClientIdentification_ClientCapabilities {
    const message = createBaseClientIdentification_ClientCapabilities();
...
function createBaseClientIdentification_ClientCredentials(): ClientIdentification_ClientCredentials {
  return { type: 0, token: new Uint8Array(0) };
}
...
export const ClientIdentification_ClientCredentials = {
  ...
  create<I extends Exact<DeepPartial<ClientIdentification_ClientCredentials>, I>>(
    base?: I,
  ): ClientIdentification_ClientCredentials {
    return ClientIdentification_ClientCredentials.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ClientIdentification_ClientCredentials>, I>>(
    object: I,
  ): ClientIdentification_ClientCredentials {
    const message = createBaseClientIdentification_ClientCredentials();
    message.type = object.type ?? 0;
...
function createBaseEncryptedClientIdentification(): EncryptedClientIdentification {
  return {
    providerId: "",
    serviceCertificateSerialNumber: new Uint8Array(0),
    encryptedClientId: new Uint8Array(0),
    encryptedClientIdIv: new Uint8Array(0),
    encryptedPrivacyKey: new Uint8Array(0),
  };
}
...
export const EncryptedClientIdentification = {
  ...
  fromJSON(object: any): EncryptedClientIdentification {
    return {
      ...
      serviceCertificateSerialNumber: isSet(object.serviceCertificateSerialNumber)
        ? bytesFromBase64(object.serviceCertificateSerialNumber)
        : new Uint8Array(0),
      encryptedClientId: isSet(object.encryptedClientId)
        ? bytesFromBase64(object.encryptedClientId)
        : new Uint8Array(0),
      encryptedClientIdIv: isSet(object.encryptedClientIdIv)
        ? bytesFromBase64(object.encryptedClientIdIv)
        : new Uint8Array(0),
      encryptedPrivacyKey: isSet(object.encryptedPrivacyKey)
        ? bytesFromBase64(object.encryptedPrivacyKey)
        : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EncryptedClientIdentification>, I>>(
    object: I,
  ): EncryptedClientIdentification {
    const message = createBaseEncryptedClientIdentification();
    message.providerId = object.providerId ?? "";
    message.serviceCertificateSerialNumber = object.serviceCertificateSerialNumber ?? new Uint8Array(0);
    message.encryptedClientId = object.encryptedClientId ?? new Uint8Array(0);
    message.encryptedClientIdIv = object.encryptedClientIdIv ?? new Uint8Array(0);
    message.encryptedPrivacyKey = object.encryptedPrivacyKey ?? new Uint8Array(0);
    return message;
  },
};
...
export const DrmCertificate = {
  ...
  fromJSON(object: any): DrmCertificate {
    return {
      ...
      testDeviceDeprecated: isSet(object.testDeviceDeprecated)
        ? globalThis.Boolean(object.testDeviceDeprecated)
        : false,
      providerId: isSet(object.providerId) ? globalThis.String(object.providerId) : "",
      serviceTypes: globalThis.Array.isArray(object?.serviceTypes)
        ? object.serviceTypes.map((e: any) => drmCertificate_ServiceTypeFromJSON(e))
        : [],
      algorithm: isSet(object.algorithm) ? drmCertificate_AlgorithmFromJSON(object.algorithm) : 1,
      rotId: isSet(object.rotId) ? bytesFromBase64(object.rotId) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<DrmCertificate>, I>>(object: I): DrmCertificate {
    ...
    message.rotId = object.rotId ?? new Uint8Array(0);
...
function createBaseDrmCertificate_EncryptionKey(): DrmCertificate_EncryptionKey {
  return { publicKey: new Uint8Array(0), algorithm: 1 };
}
...
function createBaseSignedDrmCertificate(): SignedDrmCertificate {
  return { drmCertificate: new Uint8Array(0), signature: new Uint8Array(0), signer: undefined, hashAlgorithm: 0 };
}
...
export const SignedDrmCertificate = {
  ...
  fromJSON(object: any): SignedDrmCertificate {
    return {
      drmCertificate: isSet(object.drmCertificate) ? bytesFromBase64(object.drmCertificate) : new Uint8Array(0),
      signature: isSet(object.signature) ? bytesFromBase64(object.signature) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<SignedDrmCertificate>, I>>(object: I): SignedDrmCertificate {
    const message = createBaseSignedDrmCertificate();
    message.drmCertificate = object.drmCertificate ?? new Uint8Array(0);
    message.signature = object.signature ?? new Uint8Array(0);
    message.signer = (object.signer !== undefined && object.signer !== null)
      ? SignedDrmCertificate.fromPartial(object.signer)
      : undefined;
...
function createBaseWidevinePsshData(): WidevinePsshData {
  return {
    ...
    trackType: "",
    policy: "",
    groupedLicense: new Uint8Array(0),
  };
}
...
export const WidevinePsshData = {
  ...
  fromJSON(object: any): WidevinePsshData {
    return {
      keyIds: globalThis.Array.isArray(object?.keyIds) ? object.keyIds.map((e: any) => bytesFromBase64(e)) : [],
      contentId: isSet(object.contentId) ? bytesFromBase64(object.contentId) : new Uint8Array(0),
      ...
      groupedLicense: isSet(object.groupedLicense) ? bytesFromBase64(object.groupedLicense) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<WidevinePsshData>, I>>(object: I): WidevinePsshData {
    ...
    message.contentId = object.contentId ?? new Uint8Array(0);
    ...
    message.groupedLicense = object.groupedLicense ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseWidevinePsshData_EntitledKey(): WidevinePsshData_EntitledKey {
  return {
    entitlementKeyId: new Uint8Array(0),
...
export const WidevinePsshData_EntitledKey = {
  ...
  fromJSON(object: any): WidevinePsshData_EntitledKey {
    return {
      entitlementKeyId: isSet(object.entitlementKeyId) ? bytesFromBase64(object.entitlementKeyId) : new Uint8Array(0),
      keyId: isSet(object.keyId) ? bytesFromBase64(object.keyId) : new Uint8Array(0),
      key: isSet(object.key) ? bytesFromBase64(object.key) : new Uint8Array(0),
      iv: isSet(object.iv) ? bytesFromBase64(object.iv) : new Uint8Array(0),
      entitlementKeySizeBytes: isSet(object.entitlementKeySizeBytes)
        ? globalThis.Number(object.entitlementKeySizeBytes)
        : 32,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<WidevinePsshData_EntitledKey>, I>>(object: I): WidevinePsshData_EntitledKey {
    const message = createBaseWidevinePsshData_EntitledKey();
    message.entitlementKeyId = object.entitlementKeyId ?? new Uint8Array(0);
...
function createBaseFileHashes(): FileHashes {
  return { signer: new Uint8Array(0), signatures: [] };
}
  ...
  fromJSON(object: any): FileHashes {
    return {
      ...
      signatures: globalThis.Array.isArray(object?.signatures)
        ? object.signatures.map((e: any) => FileHashes_Signature.fromJSON(e))
        : [],
    };
  },
...
export const FileHashes_Signature = {
  ...
  fromJSON(object: any): FileHashes_Signature {
    return {
      ...
      SHA512Hash: isSet(object.SHA512Hash) ? bytesFromBase64(object.SHA512Hash) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<FileHashes_Signature>, I>>(object: I): FileHashes_Signature {
    ...
    message.SHA512Hash = object.SHA512Hash ?? new Uint8Array(0);
